...
from skeleton_merger.composed_chamfer import composed_sqrt_chamfer
from skeleton_merger.merger_net import Net
...
if __name__ == "__main__":
    ...
    loader_test = torch.utils.data.DataLoader(
        dataset_test, batch_size=batch, shuffle=True, num_workers=0
    )
